...
#class CityDepartureTable(DbBaseInitializer):
#    def query_create_table(self):
#        _table_name = 'city_departure'
#        _city_departure_table_query = \
#            """
#                CREATE TABLE IF NOT EXISTS city_departure
#                (
#                    city_depart_id SERIAL NOT NULL,
#                    depart_city_name VARCHAR(60) NOT NULL,
#                    depart_code VARCHAR(50) NOT NULL,
#                    depart_country_code VARCHAR(10) NOT NULL,

#                    PRIMARY KEY (city_depart_id)
#                );
#            """
#        self.create_table(_city_departure_table_query, _table_name)
...
#class CityArrivalTable(DbBaseInitializer):
#    def query_create_table(self):
#        _table_name = 'city_arrival'
#        _city_arrival_table_query = \
#            """
#                CREATE TABLE IF NOT EXISTS city_arrival
#                (
#                    city_arrival_id SERIAL NOT NULL,
#                    arriv_city_name VARCHAR(60) NOT NULL,
#                    arriv_code VARCHAR(60) NOT NULL,
#                    arriv_country_code VARCHAR(10) NOT NULL,

#                    PRIMARY KEY (city_arrival_id)
#                );
#            """
#        self.create_table(_city_arrival_table_query, _table_name)
...
#                    PRIMARY KEY (city_arrival_id, city_depart_id)
#                );
#            """
#        self.create_table(_city_departure_table_query, _table_name)
